...
df_distancias = pd.read_excel('matriz_100_reto.xlsx')
...
class Problema_TSP:
    ...
    def __init__(self,nodo_inicio, n_pob_inicial, num_interseccion, prob_mutation, epochs):
        ...
        for u in range(len(self.generacion_num)):
            ...
            indices_a_escoger.remove(nodos_al_reves[self.nodo_inicio])

            self.generacion_num[u].append(nodo_inicio)
...
a = Problema_TSP(122, 100, 20, 0.05,10000)
